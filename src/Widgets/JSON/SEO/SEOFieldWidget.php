...
namespace Interpro\AdminPanelGenerator\Widgets\JSON\SEO;

use Interpro\AdminPanelGenerator\GeneratorException;
use Interpro\AdminPanelGenerator\Widgets\JSON\Scalar\ScalarFieldWidget;

class SEOFieldWidget extends ScalarFieldWidget
{
    /**
