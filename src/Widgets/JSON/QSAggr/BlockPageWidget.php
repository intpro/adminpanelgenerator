...
use Interpro\AdminPanelGenerator\Contracts\Widgets\BlockWidget;
...
class BlockPageWidget implements BlockWidget
{
    ...
    /**
     * @param string $name
     * @param \Interpro\Core\Contracts\Taxonomy\Types\BlockType $type
     * @param \Interpro\AdminPanelGenerator\Contracts\WidgetProvider $widgetProvider
     *
     * @return void
     */
    public function __construct($name, BlockType $type, WidgetProviderInterface $widgetProvider)
    {
        $this->name = $name;
        $this->type = $type;
